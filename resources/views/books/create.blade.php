        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['action' => 'BooksController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {{Form::date('date_published', '', ['class' => 'form-control', 'placeholder' => 'Date Published'])}}
